    ...
    <div className='flex justify-center items-center min-h-screen'>
      <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
        ...
        <div className='space-y-1'>
          <button onClick={() => passwordReset(userEmail)} className='text-xs hover:underline text-gray-400'>
            Forgot password?
          </button>
        </div>
        ...
        <div className='flex justify-center space-x-4'>
          <button onClick={() => handleSocialLogin(googleProvider)} aria-label='Log in with Google' className='p-3 rounded-sm'>
            <svg
          ...
          <button onClick={() => handleSocialLogin(twitterProvider)} aria-label='Log in with Twitter' className='p-3 rounded-sm'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 32 32'
              className='w-5 h-5 fill-current'
          ...
          <button onClick={() => handleSocialLogin(githubProvider)} aria-label='Log in with GitHub' className='p-3 rounded-sm'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 32 32'
              className='w-5 h-5 fill-current'
